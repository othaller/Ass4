...
public class Div extends BinaryExpression implements Expression {
    ...
    public Expression differentiate(String var) {
        if (this.getVariables().contains(var)) {
            if (this.exp1 instanceof Var) {
                return new Div(new Num(1), this.exp2);
            } else {
                return new Div(new Minus(new Mult(this.exp1.differentiate(var), this.exp2),
    ...
    public Expression simplify() {
        ...
        if (this.exp2.toString().equals("1.0")) {
